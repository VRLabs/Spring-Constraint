...
namespace VRLabs.SpringConstraint
{
	public class SpringConstraint : ScriptableObject
	{
		public const string packageName = "Spring-Constraint";
		...
		public static void FancyPackage()
		{
			...
			var editor = ScriptableObject.CreateInstance<SpringConstraint>();
